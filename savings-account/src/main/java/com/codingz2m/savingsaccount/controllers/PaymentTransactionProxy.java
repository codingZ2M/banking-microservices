...
public interface PaymentTransactionProxy {
	...
	@PostMapping("api/v1/payment-transaction/{transaction-date}/{transaction-details}/{amount}/{debit-credit}/{savings-account-id}/mutual-fund")
	...
	@GetMapping("api/v1/payment-transaction/{savings-account-id}")
